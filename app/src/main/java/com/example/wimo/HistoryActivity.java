...
public class HistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_search.setOnClickListener(v -> {
             ...
             *
             * MapFragment에 대한 설명은 Fragment/MapFragment.java에 작성
             */
    ...
    /**
     * DB에 있는 값을 ArrayList로 받아옴
     * 이 함수는, PrivacyInfo 단위로 담겨있는 List를, 주소만 빼서 새 List로 만들어 반환하는 함수
     *
     * 한마디로 ArrayList<PrivacyInfo> -> List<String> 으로 바꿔줌  위치정보리스트 -> 주소문장 리스트
     */
    @RequiresApi(api = Build.VERSION_CODES.N)
